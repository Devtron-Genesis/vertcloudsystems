		...
		invetex_sc_map("trx_slider", array(
			...
			"params" => array_merge(array(
				...
				"cat" => array(
					...
					"style" => "list",
					"multiple" => true,
					"options" => invetex_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), invetex_get_sc_param('categories'))
				),
				"count" => array(
		...
		vc_map( array(
			...
			"params" => array_merge(array(
				...
				array(
					...
					"value" => array_flip(invetex_array_merge(array('none' => esc_html__('- Select slider -', 'trx_utils')), invetex_get_sc_param('revo_sliders'))),
					"type" => "dropdown"
				)) : array(), array(
				array(
					"param_name" => "cat",
					...
					"class" => "",
					"value" => array_flip(invetex_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), invetex_get_sc_param('categories'))),
					"type" => "dropdown"
				),
				array(
					"param_name" => "count",
