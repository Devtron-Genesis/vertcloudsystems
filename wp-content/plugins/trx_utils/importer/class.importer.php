...
class trx_utils_demo_data_importer {
	...
	function admin_scripts(){
        wp_enqueue_style('trx_addons-importer', TRX_UTILS_PLUGIN_URL . 'importer/importer.css', array(), null);
        wp_enqueue_style( 'invetex-fontello-style',  invetex_get_file_url('css/fontello/css/fontello.css'),  array(), null);
        wp_enqueue_script('trx_addons-importer', TRX_UTILS_PLUGIN_URL . 'importer/importer.js', array('jquery'), null, true);
    }
				...
				<form id="trx_importer_form">
					...
					<div class="trx_importer_demo_set">
						...
						<div class="trx_importer_description trx_importer_description_full<?php if ($this->options['demo_set']!='full') echo ' trx_importer_hidden'; ?>">
							<ol>
								<li><?php echo wp_kses_data(__('<b>ALL EXISTING CONTENTS</b> of your website will be deleted and replaced with the new data!', 'trx_utils')); ?></li>
	...
	function get_list_pages_callback() {
		if ( !wp_verify_nonce( trx_utils_get_value_gp('ajax_nonce'), 'ajax_nonce' ) || !current_user_can('manage_options') )
			die();
