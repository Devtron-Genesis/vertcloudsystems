...
if (!function_exists('invetex_team_theme_setup')) {
	...
	function invetex_team_theme_setup() {
        ...
        add_filter('trx_utils_filter_override_options',						'invetex_team_add_override_options');
		...
		invetex_storage_set('team_override_options', array(
...
if (!function_exists('invetex_team_add_override_options')) {
    function invetex_team_add_override_options($boxes = array()) {
        $boxes[] = array_merge(invetex_storage_get('team_override_options'), array('callback' => 'invetex_team_show_override_options'));
        return $boxes;
    }
}

// Callback function to show fields in override options
if (!function_exists('invetex_team_show_override_options')) {
	function invetex_team_show_override_options() {
		global $post;

		$data = get_post_meta($post->ID, invetex_storage_get('options_prefix').'_team_data', true);
		$fields = invetex_storage_get_array('team_override_options', 'fields');
		?>
...
if (!function_exists('invetex_team_save_data')) {
	function invetex_team_save_data($post_id) {
		// verify nonce
		if ( !wp_verify_nonce( invetex_get_value_gp('override_options_team_nonce'), admin_url() ) )
			return $post_id;
