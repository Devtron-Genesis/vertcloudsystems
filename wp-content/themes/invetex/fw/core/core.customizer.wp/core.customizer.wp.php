...
if ( !function_exists( 'invetex_customizer_wp_control_js' ) ) {
	function invetex_customizer_wp_control_js() {
        wp_enqueue_style( 'invetex-customizer-wp', invetex_get_file_url('core/core.customizer.wp/core.customizer.wp.css') );
		wp_enqueue_script( 'invetex-customizer-wp-color-scheme-control', invetex_get_file_url('core/core.customizer.wp/core.customizer.wp.color-scheme.js'), array( 'customize-controls', 'iris', 'underscore', 'wp-util' ),'',true );
...
if ( !function_exists( 'invetex_customizer_wp_preview_js' ) ) {
	function invetex_customizer_wp_preview_js() {
        wp_enqueue_script( 'invetex-customizer-wp-preview', invetex_get_file_url('core/core.customizer.wp/core.customizer.wp.preview.js'), array( 'customize-preview' ),'',true );
