...
if ( !function_exists( 'invetex_template_services_4_theme_setup' ) ) {
	add_action( 'invetex_action_before_init_theme', 'invetex_template_services_4_theme_setup', 1 );
	function invetex_template_services_4_theme_setup() {
		invetex_add_template(array(
			'layout' => 'services-4',
			'template' => 'services-4',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 4/', 'invetex'),
...
// Template output
if ( !function_exists( 'invetex_template_services_4_output' ) ) {
	function invetex_template_services_4_output($post_options, $post_data) {
