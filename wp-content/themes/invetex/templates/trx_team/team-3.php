...
if ( !function_exists( 'invetex_template_team_3_theme_setup' ) ) {
	add_action( 'invetex_action_before_init_theme', 'invetex_template_team_3_theme_setup', 1 );
	function invetex_template_team_3_theme_setup() {
		invetex_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 3/', 'invetex'),
...
// Template output
if ( !function_exists( 'invetex_template_team_3_output' ) ) {
	function invetex_template_team_3_output($post_options, $post_data) {
		$show_title = true;
