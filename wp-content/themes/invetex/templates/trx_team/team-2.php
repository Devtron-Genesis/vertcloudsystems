...
if ( !function_exists( 'invetex_template_team_2_theme_setup' ) ) {
	add_action( 'invetex_action_before_init_theme', 'invetex_template_team_2_theme_setup', 1 );
	function invetex_template_team_2_theme_setup() {
		invetex_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 2/', 'invetex'),
...
// Template output
if ( !function_exists( 'invetex_template_team_2_output' ) ) {
	function invetex_template_team_2_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			...
			><div class="sc_team_item_avatar column-2_5">
					<?php invetex_show_layout($post_options['photo']); ?>
